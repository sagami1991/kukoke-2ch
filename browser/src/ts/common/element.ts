type EventName = "click" | "change" | "contextmenu";
export namespace ElementUtil {
	...
	export function addDelegateEventListener(elem: Element, eventName: EventName, selector: string, cb: (event: Event, originalTarget: Element) => void) {
